...
export const options = {
  ...
  thresholds: {
    'http_req_duration': ['p(90)<125', 'p(95)<150'], 
      'group_duration{grupo::registro de usuário}': ['p(95)<15'],
      'group_duration{grupo::realizar login}': ['p(95)<10'],
      'group_duration{grupo::cadastrar pet}': ['p(95)<20'],
      'group_duration{grupo::Simula o pensamento do usuário}': ['p(95)<5'],
